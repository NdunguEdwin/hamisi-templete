...
<head>
    <meta charset="utf-8">
    <title>Mastermind World - The Best Unisex Salon </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Responsive Minimal Salon Website">
                        ...
                        <nav>
                            <ul id="mainmenu">
                                <li><a href="index.php">Home</a>
                                    <ul>
										<li><a href="index-dark-1.html">New Homepage Dark</a></li>
                                        <li><a href="index-spa-1.html">New Homepage Spa</a></li>
                                        <li><a href="index.html">Homepage 1</a></li>
                                        <li><a href="index-2.html">Homepage 2</a></li>
                                        <li><a href="index-3.html">Homepage 3</a></li>
                                        <li><a href="index-4.html">Homepage 4</a></li>
                                        <li><a href="index-5.html">Homepage 5</a></li>
                                        <li><a href="index-coming-soon-1.html">Coming Soon Page 1</a></li>
                                        <li><a href="index-coming-soon-2.html">Coming Soon Page 2</a></li>
                                    </ul>
                                </li>
                    ...
                    <ul>
                        ...
                        <li data-transition="boxfade" data-slotamount="10" data-masterspeed="800" data-thumb="">
                            ...
                            <div class="tp-caption sfb"
                                ...
                                data-start="1100"
                                data-easing="easeInOutExpo">
                                <a href="#" class="btn-slider">Read More</a>
                            </div>
                        </li>
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box padding20">
                                            ...
                                            <div class="info-box_text">
                                                ...
                                                <div class="info-box_subtite">720-50400 Nairobi, Kenya</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="info-box padding20">
                                            ...
                                            <div class="info-box_text">
                                                ...
                                                <div class="info-box_subtite">+254 333 4444</div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <section id="section-top-reason" class="no-top no-bottom">
                <div class="container-fluid">
                    <div class="row-fluid display-table">
                        ...
                        <div class="col-md-4 text-middle text-light" data-bgimage="url(images/background/bg-div-1.jpg)">
        ...
        <footer>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="widget widget-address">
                            ...
                            <address>
                                <span>720-50400 Nairobi, Kenya</span>
                                <span><strong>Phone:</strong>+254 333 4444</span>
                                <span><strong>Fax:</strong>+254 333 4444</span>
                                <span><strong>Email:</strong><a href="mailto:contact@mastermind-salon.com">contact@mastermind-salon.com</a></span>
                                <span><strong>Web:</strong><a href="#">http://mastermind-salon.com</a></span>
                            </address>
                        </div>
                    </div>
            ...
            <div class="subfooter">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            &copy; Copyright 2024 - Mastermind Salon
                        </div>
